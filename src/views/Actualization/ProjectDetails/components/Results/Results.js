                                ...
                                <Table stickyHeader>
                                    <TableHead>
                                        <TableRow>
                                            ...
                                            <TableCell style={{ minWidth: 230 }}>Телефон</TableCell>
                                            <TableCell style={{ minWidth: 170 }}>Часы работы</TableCell>
                                            <TableCell>Особенности</TableCell>
                                            <TableCell>Фотографии заведения</TableCell>
                                            <TableCell>Цитаты из меню</TableCell>
                                            <TableCell style={{ maxWidth: 200 }}>Файлы меню</TableCell>
                                            <TableCell style={{ maxWidth: 200 }}>Тип заведения</TableCell>
